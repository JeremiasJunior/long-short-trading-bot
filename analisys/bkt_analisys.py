...
from backend import bkt, bkt_d1, bkt_old
...
class runbkt_d1:
    ...
    def __new__(self, symbol_x, 
        ...
        self.results = bkt_d1.bkt_godhand(independent_ticker=name_x, dependent_ticker=name_y,
                                        df_x = symbol_x, df_y = symbol_y,
                                        short_spread = s_spread, long_spread= l_spread,
                                        column = 'close', position_size=p_size, stop_number=stop_n, min_count=c_min,
                                        tp_long=tp_l, tp_short=tp_s,
...
class runbkt_old:
    ...
    def __new__(self, symbol_x, 
        ...
        self.results = bkt_old.bkt_godhand(independent_ticker=name_x, dependent_ticker=name_y,
                                        df_x = symbol_x, df_y = symbol_y,
                                        short_spread = s_spread, long_spread= l_spread,
                                        column = 'close', position_size=p_size, stop_number=stop_n, min_count=c_min,
                                        tp_long=tp_l, tp_short=tp_s,
